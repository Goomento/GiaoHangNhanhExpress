# Magento 2 **GiaoHangNhanhExpress**, module allows your store connect with Giao Hang Nhanh merchant that can boot sales from a quick and easy shipment process 
